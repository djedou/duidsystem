...
(function (global, factory) {
	...
	(global = global || self, factory(global['duidsystem-duidhtml'] = {}, global.React));
	...
	*/
	...
	var Form = function Form(props) {
	  var children = props.children,
	      style = props.style,
	      others = objectWithoutProperties(props, ["children", "style"]);

	  return React__default.createElement("form", _extends_1({
	    className: style
	  }, others), children);
	};
	...
	var Button = function Button(props) {
	  var children = props.children,
	      style = props.style,
	      prop = objectWithoutProperties(props, ["children", "style"]);
	...
	var DropDawDatalist = function DropDawDatalist(props) {
	  ...
	  }, labelProps.name), React__default.createElement("input", {
	    type: "text",
	    id: inputProps.id,
	    list: inputProps.list,
	    className: inputStyle
	  }), React__default.createElement("datalist", {
	    id: datalistProps.id
	...
	var DropDawSelect = function DropDawSelect(props) {
	  ...
	  return React__default.createElement(React__default.Fragment, null, React__default.createElement("label", {
	    className: labelStyle,
	    htmlFor: labelProps.htmlFor
	  }, labelProps.name), React__default.createElement("select", _extends_1({
	    className: selectStyle
	  }, selectProps), optionItems.map(function (item) {
	    var optionItemProps = item.optionItemProps;
	    return React__default.createElement("option", _extends_1({
	      key: item.value,
	      value: item.value
	...
	var DropDawSelectGroup = function DropDawSelectGroup(props) {
	  ...
	  return React__default.createElement(React__default.Fragment, null, React__default.createElement("label", {
	    ...
	    return React__default.createElement("optgroup", _extends_1({
	      key: item.groupId
	...
	var FormFieldset = function FormFieldset(props) {
	  ...
	  return React__default.createElement(React__default.Fragment, null, React__default.createElement("fieldset", _extends_1({
	    className: fieldsetStyle
	  }, fieldsetProps), React__default.createElement("legend", _extends_1({
	...
	var InputCheckbox = function InputCheckbox(props) {
	  var value = props.value,
	      labelProps = props.labelProps,
	      style = props.style,
	      others = objectWithoutProperties(props, ["value", "labelProps", "style"]);

	  return React__default.createElement(React__default.Fragment, null, React__default.createElement("label", _extends_1({}, labelProps, {
	    className: style
	...
	var InputColor = function InputColor(props) {
	  var colorTitle = props.colorTitle,
	      labelProps = props.labelProps,
	      style = props.style,
	      colorProps = objectWithoutProperties(props, ["colorTitle", "labelProps", "style"]);

	  return React__default.createElement(React__default.Fragment, null, React__default.createElement("label", _extends_1({
	    className: style
	  }, labelProps), colorTitle), React__default.createElement("input", _extends_1({
	    type: "color",
	...
	exports.DropDawDatalist = DropDawDatalist;
	exports.DropDawSelect = DropDawSelect;
	exports.DropDawSelectGroup = DropDawSelectGroup;
